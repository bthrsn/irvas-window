...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(modalState); // Что доработать в форме калькулятора
...
var changeModalState = function changeModalState(state) {
  var windowForm = document.querySelectorAll('.balcon_icons_img '),
      ...
      wihdowHeight = document.querySelectorAll('#height'),
  ...
  bindActionToElems('input', wihdowHeight, 'height');
...
var checkNumInputs = function checkNumInputs(selector) {
  var numInputs = document.querySelectorAll(selector); // Проверка на не числа при вводе и их замена на пустую строку
...
var images = function images(imgParentSelector) {
  var imgPopup = document.createElement('div'),
      workSection = document.querySelector(imgParentSelector),
      bigImage = document.createElement('img'); // Модальные окна в верстке были с классом popup
  // imgPopup.classList.add('popup');

  workSection.append(imgPopup); // Можно через класс в bootstrap, а можно через css стили

  imgPopup.style.justifyContent = 'center';
  imgPopup.style.alignItems = 'center';
  imgPopup.style.display = 'none'; // Ддоавляем элемент с большим изображением

  imgPopup.append(bigImage); //Задать размер изображению - нужно для маленьких экранов

  bigImage.style.maxWidth = "".concat(window.innerWidth / 2, "px");
  workSection.addEventListener('click', function (e) {
    e.preventDefault();
    var target = e.target; // Создаем модальное окно с большим изображением

    if (target && target.classList.contains('preview')) {
      imgPopup.classList.add('popup');
      imgPopup.style.display = 'flex'; // Убрать прокрутку

      document.body.style.overflow = 'hidden'; // У родител изображения есть ссылка, которую мы получаем

      var path = target.parentNode.getAttribute('href'); // А потом устанавливаем как свойство картинки на которую кликнули
...
var timer = function timer(timerSelector, deadline) {
  ...
  var setClock = function setClock(selector, endtime) {
    ...
    function updateClock() {
      ...
      days.textContent = Object(_addZero__WEBPACK_IMPORTED_MODULE_0__["default"])(t.days);
      hours.textContent = Object(_addZero__WEBPACK_IMPORTED_MODULE_0__["default"])(t.hours);
      minutes.textContent = Object(_addZero__WEBPACK_IMPORTED_MODULE_0__["default"])(t.minutes);
      seconds.textContent = Object(_addZero__WEBPACK_IMPORTED_MODULE_0__["default"])(t.seconds);
